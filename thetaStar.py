    ...
    while openset:
        ...
        for node in children(current,grid):
            ...
            if node in openset:
                ...
                #aqui creamos el if de LineOfSight
                if line_of_sight(current.parent,node,grid):
...
def line_of_sight(nodo1,nodo2,grid):
    x0, y0 = nodo1.grid_point
    x1, y1 = nodo2.grid_point
    dy = y1 - y0
    dx = x1 - x0
    f = 0
